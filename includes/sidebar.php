...
$navGroups = [
    [
        'label' => 'Sales',
        'items' => [
            ['id'=>'quotation', 'label'=>'Quotations',        'icon'=>'bi-file-earmark-text', 'href'=>'/pages/sales.php?type=quotation'],
            ['id'=>'order',     'label'=>'Sales Orders',      'icon'=>'bi-bag-check',         'href'=>'/pages/sales.php?type=order'],
            ['id'=>'invoice',   'label'=>'AR Invoices',       'icon'=>'bi-receipt',           'href'=>'/pages/sales.php?type=invoice'],
            ['id'=>'payments',  'label'=>'Incoming Payments', 'icon'=>'bi-cash-stack',        'href'=>'/pages/payments.php'],
        ],
    ],
    [
        'label' => 'Finance',
    ...
    [
        'label' => 'Inventory',
        'items' => [
            ['id'=>'items',     'label'=>'Items',             'icon'=>'bi-box-seam',          'href'=>'/pages/items.php'],
            ['id'=>'inventory', 'label'=>'Inventory',         'icon'=>'bi-boxes',             'href'=>'/pages/inventory.php'],
        ],
    ],
    [
        'label' => 'Partners',
    ...
    [
        ...
        'items'    => [
            ...
            ['id'=>'users',     'label'=>'Users',             'icon'=>'bi-person-gear',       'href'=>'/pages/users.php'],
        ],
    ],
];
?>
<div class="sidebar" id="sidebar">
    <div class="sidebar-header">
        <div class="sidebar-logo">
            <?php if ($companyLogo): ?>
            <img src="/<?= htmlspecialchars($companyLogo) ?>" id="sidebarLogo" class="company-logo-img" alt="Logo">
            <?php else: ?>
            <img src="/assets/img/logo.svg" class="sidebar-logo-icon" id="sidebarLogo" alt="LumenBooks" style="width:36px;height:36px;background:none;padding:0">
            <?php endif; ?>
    ...
    <nav class="sidebar-nav">
        <?php foreach ($navGroups as $group):
            if (!empty($group['adminOnly']) && !$isAdmin) continue;
        ?>
